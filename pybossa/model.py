...
class Project(db.Model, DomainObject):
    ...
    #: Unique id for this project (autogenerated)
    id = Column(Integer, primary_key=True)
    #: created timestamp (automatically set)
    created = Column(Text, default=make_timestamp)
    #: Name / Title for this Project
    ...
    #: Allow anonymous contributors to participate in the project tasks
    ...
    #: this Project should be hidden from everyone but Administrators
    ...
    #: stores information used by PyBossa, such as the project thumbnail,
    ...
    ## Relationships
    #: `Task`s for this project.`
    tasks = relationship('Task', cascade='all, delete-orphan', backref='project')
    #: `TaskRun`s for this project.`
    task_runs = relationship('TaskRun', backref='project',
                             cascade='all, delete-orphan',
                             order_by='TaskRun.finish_time.desc()')
    #: `Featured` or not for this project
    featured = relationship('Featured', cascade='all, delete-orphan')
    #: `category` or not for this project
    ...
    def completion_status(self):
        ...
        results = db.engine.execute(sql, project_id=self.id)
        for row in results:
...
class Task(db.Model, DomainObject):
    ...
    #: created timestamp (automatically set)
    created = Column(Text, default=make_timestamp)
    #: ForeignKey to Project.id (NB: use task relationship rather than this field
    #: in normal use
    project_id = Column(Integer, ForeignKey('project.id'))
    ...
    #: Value between 0 and 1 indicating priority of task within Project
